...
public class Network extends Thread {
    ...
    private static Semaphore emptyInBufferSlotsSemaphore;
    private static Semaphore fullInBufferSlotsSemaphore;
    private static Semaphore emptyOutBufferSlotsSemaphore;
    private static Semaphore fullOutBufferSlotsSemaphore;
    private static Semaphore mutexInBuffer;
    private static Semaphore mutexOutBuffer;
     ...
     Network( )
      {
         ...
         networkStatus = "active";
          ...
          emptyInBufferSlotsSemaphore = new Semaphore(maxNbPackets);
          fullInBufferSlotsSemaphore = new Semaphore(0);
          emptyOutBufferSlotsSemaphore = new Semaphore(maxNbPackets);
          fullOutBufferSlotsSemaphore = new Semaphore(0);
          mutexInBuffer = new Semaphore(1);
          mutexOutBuffer = new Semaphore(1);
      }     
     ...
     */
        ...
        {
            try {
                emptyInBufferSlotsSemaphore.acquire();
                mutexInBuffer.acquire();
            ...
            fullInBufferSlotsSemaphore.release();
            mutexInBuffer.release();
     ...
     */
         public static boolean receive(Transactions outPacket)
        {
            try {
                ...
                fullOutBufferSlotsSemaphore.acquire();
                mutexOutBuffer.acquire();
            ...
            emptyOutBufferSlotsSemaphore.release();
            mutexOutBuffer.release();
     ...
     */
         public static boolean transferOut(Transactions outPacket)
        {
            try {
                ...
                emptyOutBufferSlotsSemaphore.acquire();
                mutexOutBuffer.acquire();
            ...
            fullOutBufferSlotsSemaphore.release();
            mutexOutBuffer.release();
       ...
       public static boolean transferIn(Transactions inPacket)
        {
            try {
                ...
                fullInBufferSlotsSemaphore.acquire();
                mutexInBuffer.acquire();
            ...
            emptyInBufferSlotsSemaphore.release();
            mutexInBuffer.release();
